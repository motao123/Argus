...
### 阶段 0 安全基线整改（2026-08-16 追加）

统一 REST/WS/MCP 授权、跨租户与 hidden 修复、删除误绑过户路由、Agent 注册密钥化、
WAF 时间窗口、可信代理、通知 TLS、插件/通知 admin 收紧，均已实现并补测试与
双用户端到端复验（详见 docs/verification.md 第十一节）。
